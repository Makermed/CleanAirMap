...
import { LocationModel, RoomModel, LocationModelInput, ReadingModel } from '../../dataTypes'
...
export class LocationDAO implements ILocation {
    ...
    {
        return this.client.location.findUnique( { where: { locationId: locationId } }).readings();
    }
}