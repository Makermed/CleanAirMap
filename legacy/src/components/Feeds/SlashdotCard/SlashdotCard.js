...
class SlashdotCard extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    // // link preview
    // let preview = null;
    // if (article.link_preview !== null && article.link_preview.title !== "" && 
        ...
        <div className={classes.carddiv}>
          <CardHeader
            ...
            avatar={
              <div>
                ...
                <img
                  alt={"slashdot"}
                  src={`/static/images/icons/${theme_mode}/slashdot.png`}
          ...
          <CardActions>
            ...
            <Button
              ...
              onClick={e => handleClick(article)}
            >
              <Typography className={classes.readmore}>comments</Typography>
              <ChevronRightIcon
                fontSize="small"
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(SlashdotCard));
