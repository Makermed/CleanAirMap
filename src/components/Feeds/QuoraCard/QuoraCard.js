...
class QuoraCard extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let hasImage = (article_image !== "") && (article_image !== null);
    if (article.extra_data !== null) {
      if (article.extra_data.image !== "" && article.extra_data.image !== null) {
        hasImage = true;
        article_image = article.extra_data.image;
      }
    }
