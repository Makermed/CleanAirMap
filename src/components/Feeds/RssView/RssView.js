        ...
        <Card className={classes.card} style={{ width: width - 16}}>
          <div className={classes.carddiv}>
            <CardHeader
              ...
              avatar={
                <div>
                  ...
                  {/* <img
                    alt={"rss"}
                    src={`/static/images/icons/${theme_mode}/rss.png`}
            ...
            <CardContent className={classes.content}>
              <Typography className={classes.detail_txt} variant="body2">{render_text(summary, theme_mode === THEME_MODE_DARK)}</Typography>
            </CardContent>
            {preview !== null && (
